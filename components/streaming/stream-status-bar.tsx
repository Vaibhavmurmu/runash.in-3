  ...
  return (
    <div className="bg-white dark:bg-gray-900 border-t border-orange-100 dark:border-orange-900/20 p-3 flex items-center justify-between">
      <div className="flex items-center space-x-4">
        ...
        <div className="flex items-center">
          <p className="text-xs text-gray-500 dark:text-gray-400 mr-4">Stream Health: {streamHealth}</p>
          <PlatformStatusBar isStreaming={isStreaming} activePlatforms={activePlatforms} />
        </div>
      </div>
      <div className="flex items-center space-x-4">
        <div className="flex items-center">
